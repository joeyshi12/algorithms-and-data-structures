...
bool canProcess(int x, int y, center c, PNG& img, PNG& imgCopy, unordered_set<HSLAPixel*>& visited, double tol);

void processPoint(int x, int y, center c, PNG& img, colorPicker* cp, unordered_set<HSLAPixel*>& visited, OrderingStructure<point>& os);

void processFrame(animation& animation, PNG& img, unordered_set<HSLAPixel*>& visited, int frameFreq);
