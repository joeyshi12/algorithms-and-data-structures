...
namespace GraphTools
{
    ...
    /**
     * Does a BFS of a graph, keeping track of the shortest
     *  path seen so far.
     */
    void shortestPathBFS(Graph& graph, Vertex start, Vertex end, unordered_map<Vertex, Vertex>& parent);
     ...
     */
    Edge minWeightBFS(Graph& graph, Vertex start);
